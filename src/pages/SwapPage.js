      ...
      <div className="rounded-lg p-6 w-full max-w-lg">
        ...
        <div className="flex justify-between">
          <div className="flex">
            <button
              ...
              className={`flex items-center px-4 py-2 ${activeTab === 'same-chain' ? 'bg-white-01 text-white font-extrabold' : 'bg-gray-800 text-secondary font-normal'} rounded-t-lg`}
            >
              <img src={sameChainIcon} alt="Same-chain Icon" className="w-4 h-4 mr-2" />
              Same-chain
            </button>

            <button
              onClick={() => setActiveTab('cross-chain')}
              className={`flex items-center px-4 py-2 ${activeTab === 'cross-chain' ? 'bg-white-01 text-white font-extrabold' : 'bg-gray-800 text-secondary font-normal'} rounded-t-lg`}
            >
              <img src={crossChainIcon} alt="Cross-chain Icon" className="w-4 h-4 mr-2" />
              Cross-chain
            </button>
          </div>
        </div>
        ...
        <div className="bg-gray-700 p-4 rounded-[0px_10px_10px_10px] shadow-custom-card border border-stroke backdrop-blur-md">
          ...
          <div className="bg-gray-700 border border-stroke p-2 rounded-lg">
            <div className="flex flex-col items-start">
              <div className="text-left">
                <span className="text-sm font-normal text-gray-400">Pay from </span>
                <span className="cursor-pointer text-sm font-bold text-primary">Connect Wallet</span>
              </div>
            </div>
          ...
          <div className="bg-gray-700 border border-stroke p-2 rounded-lg mb-4">
            <div className="flex flex-col items-start">
              <div className="text-left">
                <span className="text-sm font-normal text-gray-400">Receive to </span>
                <span className="cursor-pointer text-sm font-bold text-primary">Connect Wallet</span>
              </div>
            </div>
                ...
                <div className="flex items-center justify-center p-4 rounded-lg bg-gray-700 border border-stroke shadow-md">
                  <div className="flex items-center justify-start">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <div className="text-white font-bold text-lg">Token</div>
                      {/* on Chain Text */}
                      <div className="text-gray-400 text-xs">on Chain</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="bg-gray-800 border border-stroke mt-4 rounded-lg p-6 w-full max-w-lg">
        ...
        >
          ...
          <div className="mt-4 text-secondary">
            <div className="flex justify-between">
              <span className="text-sm font-manrope font-normal leading-5 text-color-4">Minimum Received</span>
              <span className="text-sm font-manrope font-normal leading-5 text-color-4">0.00</span>
            </div>
            <div className="flex justify-between mt-2">
              <span className="text-sm font-manrope font-normal leading-5 text-color-4">Transaction Fee</span>
              <span className="text-sm font-manrope font-normal leading-5 text-color-4">0.00</span>
            </div>
            <div className="mt-4">
              <a href="#" className="flex items-center text-xs font-bold font-manrope leading-4 text-primary">
                More routes
